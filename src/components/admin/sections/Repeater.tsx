    ...
    <div className="space-y-3">
      <div className="flex items-end justify-between gap-3">
        ...
        <button
          type="button"
          onClick={add}
          className="rounded-xs border border-line bg-cream px-3 py-1.5 font-sans text-[10px] font-medium uppercase tracking-[0.18em] text-ink transition-colors hover:border-ink/40"
        >
          + {addLabel}
        </button>
      </div>
