...
export default function MonetisationItemBlock({
  ...
  return (
    <li className="flex items-start gap-4 border-b border-line py-4 last:border-b-0">
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-line bg-cream font-sans text-[11px] font-bold tracking-[0.08em] text-ink">
        {numberLabel}
      </span>
      ...
      <a
        ...
        className="shrink-0 self-center font-sans text-[11px] font-bold uppercase tracking-[0.18em] text-action transition-opacity hover:opacity-80"
      >
        {block.cta.label} →
      </a>
    </li>
